Feature: services page
  ...
  Scenario: the services page should have a header and a footer
  Scenario: the services page should have a right menu with links to our services details and a small text stating how proud we are of our work
  
  Scenario: the services page should have a overview of each service we provide
  Scenario: each service should have a service name
